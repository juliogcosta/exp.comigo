...
import br.com.comigo.atendimento.api.adapter.outbound.aggregate.atendimento.JpaAtendimento;
...
public interface JpaAtendimentoRepository extends JpaRepository<JpaAtendimento, Long> {
    ...
    Page<AtendimentoItemDeServicoDoAtendimentoProjection> findAtendimentosComItensDeServicoByPrestadorId(
    ...
    Page<AtendimentoItemDeServicoDoAtendimentoProjection> findAtendimentosComItensDeServicoByVeiculoPlaca(
    ...
    Page<AtendimentoItemDeServicoDoAtendimentoProjection> findAtendimentosComItensDeServicoByClienteTelefoneNumero(
