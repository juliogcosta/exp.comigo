...
public interface JpaServicoRepository extends JpaRepository<JpaServico, String> {
    ...
    Page<ServicoItemDeServicoProjection> findItemDeServicoByServicoId(@Param("servicoId") String servicoId, Pageable pageable);
}