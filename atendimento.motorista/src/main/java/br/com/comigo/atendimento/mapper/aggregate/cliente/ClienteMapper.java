package br.com.comigo.atendimento.mapper.aggregate.cliente;
...
public interface ClienteMapper {
        ...
        default Cliente fromJpaToDomain(JpaCliente jpaCliente) {
                ...
                Telefone telefone = new Telefone(jpaCliente.getTelefone().getNumero(),
                                jpaCliente.getTelefone().getTipo());

                Telefone whatsapp = new Telefone(jpaCliente.getTelefone().getNumero(),
                                jpaCliente.getTelefone().getTipo());
                ...
                Endereco endereco = new Endereco(
                                jpaCliente.getEndereco().getLogradouro(),
